...
df <- read.csv("C:/Users/sambi/Downloads/GNP data.csv")
glimpse(df)
```
...
$$\small H_0: \rho_1 = \rho_2 = \cdots = \rho_m = 0 \quad vs\quad H_1: Not\ H_0$$ $\small \rho_k$ being the auto-correlation at lag k.
...
The final model we consider is as follows: $\scriptsize\mathbf{x_t = 3.0956 + 1.0292x_{t-1} - 0.945x_{t-4} + 0.8607x_{t-5} - 0.7319x_{t-8} + 0.718x_{t-9} - 0.5338x_{t-12} + 0.378x_{t-13}}$
